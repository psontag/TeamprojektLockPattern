...
public class FragmentMain extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        Button btnWrite = (Button) getView().findViewById(R.id.write_button);
        Button btnCheck = (Button) getView().findViewById(R.id.Check_button);
        final TextView password_w = (TextView)getView().findViewById(R.id.password_write);
        final TextView password_c = (TextView)getView().findViewById(R.id.password_check);
